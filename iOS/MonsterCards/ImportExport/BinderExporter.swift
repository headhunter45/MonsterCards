...
//  MonsterCards
//
//  Serialises MonsterViewModel -> Binder platform JSON.
//
...
struct BinderExport {
    ...
    struct CollectionExport {
        ...
        init(id: String, name: String, description: String, cards: [[String: Any]]) {
            self.id = id
            self.name = name
        ...
        static func named(_ name: String, cards: [[String: Any]]) -> CollectionExport {
...
struct MonsterExport {
    ...
    static func makeDictionary(monster: MonsterViewModel, idOverride: UUID? = nil) -> [String: Any] {
        var d: [String: Any] = [
            ...
            // Saving throw proficiencies & advantages
            ...
            "otherArmorDescription": monster.customArmor,
            ...
            "skills": monster.skills.map { s -> [String: Any] in
                return ["name": s.name, "stat": s.abilityScore.rawValue, "proficiency": s.proficiency.rawValue]
            },
